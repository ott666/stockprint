    ...
    return(
        <Container>
            <div className="flex flex-col w-[100%] h-[100%]">
                <h1 className="text-center  text-4xl">Nossos produtos</h1>
                <div className="flex flex-wrap justify-between w-[100%] pt-[50px]">
                    ...
                    <CardMainItem url={BgCard2} text='Impressoras de cartao' url2={ImgCard2} alt='Ribbons 084051'/>
                    <CardMainItem url={BgCard3} text='Impressoras de cartao' url2={ImgCard3} alt='Kit 086177'/>
                    <CardMainItem url={BgCard4} text='Impressoras de cartao' url2={ImgCard4} alt='Zebra ZD220'/>
                </div>
